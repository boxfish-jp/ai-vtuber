...
export const Biim = ({
  ...
  return (
    <main className="w-[1280px] h-[720px] bg-black flex flex-row items-end gap-1 p-1">
      <div className="w-full h-[100px] flex flex-row gap-1 justify-end">
        <div
          className={`w-[830px] border-[3px] border-white text-white p-3 ${
            subtitle ? "text-center text-lg" : ""
          }`}
        >
          {subtitle
            ? subtitle
      ...
      <div className="w-[220px] h-full flex flex-col gap-1">
        <div className="h-[200px] border-[3px] border-white flex justify-center items-center">
          <p className="text-xl text-white text-center my-auto">
            {workTheme.main}
          </p>
        </div>
        <div className="h-full border-[3px] border-white">
          <p className="text-2xl text-white text-center mb-4">作業の流れ</p>
